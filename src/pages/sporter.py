                    ...
                    children=[
                        ...
                        html.P(
                            [
                                "Fäktning:",
                                html.Br(),
                                "Tom. 1956: Ungern och Frankrike klar ledning",
                                html.Br(),
                                "Tom. 1976: Soviet och Ungern klar ledning",
                                html.Br(),
                                "Tom. 1996: Frankrike och Italien närmar sig ledarna",
                                html.Br(),
                                "Tom. 2016: Frankrike och Italien går om",
                                html.Br(),
                                "Ishockey:",
                                html.Br(),
                                "Tom. 1956: USA och Kanada klar ledning",
                                html.Br(),
                                "Tom. 1976: Soviet och Tjeckien går om",
                                html.Br(),
                                "Tom. 1996: Sverige går om USA",
                                html.Br(),
                                "Tom. 2016: USA går om Sverige, Finland fyra",
                                html.Br(),
                                "Freestyle:",
                                html.Br(),
                                "Tom. 1986: Inga medaljer eftersom grenen är ny",
                                html.Br(),
                                "Tom. 1996: Många har lika många medaljer",
                                html.Br(),
            ...
            children=[
                dbc.Col(
                    children=[
                        ...
                        html.P(
                            [
                                "Tom. 1976: Fler tävlande och högre medelålder i fäktning än i Ishockey.",
                                html.Br(),
                                "Tom. 1996: Freestyle får sina första tävlande.",
                                html.Br(),
            ...
            children=[
                dbc.Col(
                    children=[
                        ...
                        html.P(
                            [
                                "Tom. 1956: Ishockey och fäktning lika median BMI.",
                                html.Br(),
                                "Första damerna till ishockey 2006. Fäktning har första damerna mycket tidigare.",
                                html.Br(),
                                "Nyare tider tydlig skillnad på BMI mellan ishockey och fäktning till skillnad från äldre då de var lika.",
                                html.Br(),
